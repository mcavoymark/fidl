; $Id: xmanager.pro,v 12.55 1999/01/29 21:08:32 jmo Exp $
;
...
PRO XmanagerPrintError
  ...
  message, /NONAME, /CONTINUE, $
      'XMANAGER: Caught unexpected error from client application. Message follows...'
  printf, -2, !msg_prefix, err
  if (strlen(syserr) gt 0) then printf, -2, !msg_prefix, syserr
