#Copyright 2/21/17 Washington University.  All Rights Reserved.
#make_fidl_rt_export.csh  $Revision: 1.2 $
if($#argv < 4) then

    #echo Usage: make_fidl_rt.csh LIB_PATH INSTALL_PATH FIDL_RT_PATH IDL_DIR VM_DIR LICENSE_FILE
    #START170221
    echo Usage: make_fidl_rt_export.csh LIB_PATH INSTALL_PATH FIDL_RT_PATH VM_DIR
