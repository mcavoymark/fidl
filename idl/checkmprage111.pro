...
;checkmprage111.pro  $Revision: 1.2 $

;********************************
pro checkmprage111,fi,wd,dsp,help
;********************************

filnam_4dfp = dialog_pickfile(FILTER='*img',PATH=fi.path, $
       GET_PATH=wrtpath,TITLE='Select mprage 111_t88 file.')
...
printf,lu_csh,FORMAT='("checkmprage111 ",a)',tail
close,lu_csh
free_lun,lu_csh
spawn,'csh cover.csh'
spawn,'rm cover.csh'
