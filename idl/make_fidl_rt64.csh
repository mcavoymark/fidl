#Copyright 11/20/15 Washington University.  All Rights Reserved.
#make_fidl_rt64.csh  $Revision: 1.7 $
...
#START151119
if($#argv < 4) then
    echo Usage: make_fidl_rt.csh LIB_PATH INSTALL_PATH FIDL_RT_PATH IDL_DIR
    exit
endif
...
#START151216
echo 'setenv FIDL_LINECOLORSFILE ' ${INSTALL_PATH}'/idl_8.3/linecolors.dat' >> $FILENAME 
...
echo 'setenv IDL_DIR /home/usr/fidl/vm/idl83' >> $FILENAME
echo 'setenv IDL_LIB $IDL_DIR/lib' >> $FILENAME
echo 'setenv IDL_PATH +'${INSTALL_PATH}'/${IDL2}:+$IDL_DIR/lib' >> $FILENAME
echo '${IDL_DIR}/bin/idl -vm='${INSTALL_PATH}'/${IDL2}/main.sav' >> $FILENAME
