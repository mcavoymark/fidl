/* Copyright 8/19/14 Washington University.  All Rights Reserved.
   fidl_lang_test_evRT.c  $Revision: 1.2 $ */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
#if 0
static char rcsid[] = "$Header: /home/hannah/mcavoy/idl/clib/RCS/fidl_lang_test_evRT.c,v 1.2 2014/08/20 21:41:43 mcavoy Exp $";
#endif 

int main(int argc,char **argv)
{
char *txtfile=NULL,*txtfile6=NULL,*concfile=NULL,filename[MAXNAME],*out=NULL;
int i,j,k,i1,j1,skipblock=0,sentperblock=0,oldresponse=0,SunOS_Linux,colperrun,nblock,cond,*condn,**condnrun,miss;
...
printf("oldold= %2d oldnew= %2d newold= %2d newnew= %2d miss= %2d\n",condn[0],condn[1],condn[2],condn[3],condn[miss]);
printf("accuracy oldold= %f newnew= %f\n",(double)condn[0]/(double)(condn[0]+condn[1]),(double)condn[3]/(double)(condn[2]+condn[3]));
